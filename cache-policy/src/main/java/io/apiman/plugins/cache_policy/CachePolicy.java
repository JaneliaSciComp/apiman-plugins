...
public class CachePolicy extends AbstractMappedDataPolicy<CacheConfig> implements IDataPolicy {
    ...
    private static final String CACHE_ID_ATTR = CachePolicy.class.getName() + ".cache-id"; //$NON-NLS-1$
    private static final String CACHED_RESPONSE = CachePolicy.class.getName() + ".cached-response"; //$NON-NLS-1$
