...
import io.apiman.plugins.authn_policy.config.LDAPBindAsType;
import io.apiman.plugins.authn_policy.config.LDAPIdentitySource;
        ...
        .setLdapErrorHandler(new IAsyncHandler<LdapException>() {
            ...
            public void handle(List<ILdapSearchEntry> result) {
                ...
                for (ILdapSearchEntry searchResult : result) {
                    ...
                    context.setAttribute(AUTHENTICATED_USER_ROLES, roles);
